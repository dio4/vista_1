...
class CReportOnPaidServicesPZ12(CReport):
    ...
    def build(self, params):
        ...
        tableColumns = [
            ...
            ('%50', [u'', u'', u''], CReportBase.AlignRight),
            ('%50', [u'', u'', u''], CReportBase.AlignRight),
            ...
            ('%5', [u'Запломбировано зубов', u'', u'7A'], CReportBase.AlignLeft),
        ...
        for index, value in enumerate(total):
            table.setText(i, index + 3, value, CReportBase.TableTotal)
        return doc
...
def main():
    ...
    w = CReportOnPaidServicesPZ12(None)
    w.exec_()
