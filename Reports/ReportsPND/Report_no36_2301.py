...
class CReportReHospitalization(CReport):
    ...
    def build(self, params):
        ...
        tableColumns = [
            ('100%', [u'Число поступивших пациентов с психическими расстройствами, классифицированные в других рубриках МКБ-10 1______, из них поступило повторно 2 ______.'],
