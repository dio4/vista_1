...
class CReportExposedDD(CReport):
    ...
    def build(self, params):
        ...
        tableColumns = [
            ...
            ( '15%', [u'Количество медицинских организаций, проводящих диспансеризацию в отчетном периоде', u'', u''], CReportBase.AlignCenter),
            ( '15%', [u'Численность застрахованных лиц, прикрепленных к медицинским организациям, оказывающим первичную медико-санитарную помошь, на отчетную дату, человек', u'', u''], CReportBase.AlignRight),
            ( '15%', [u'в том числе:', u'подлежащие диспансеризации в отчетном году, согласно утвержденному плану-графику, всего, человек', u''], CReportBase.AlignRight),
            ( '15%', [u'', u'из них:', u'на отчетный период, человек'], CReportBase.AlignRight),
            ( '15%', [u'Всего предъявленных к оплате реестров счетов в рамках диспансеризации на отчетную дату, тыс. рублей', u'', u''], CReportBase.AlignRight),
            ...
            ( '15%', [u'', u'', u'тыс. рублей'], CReportBase.AlignRight),
            ( '15%', [u'Оплачено в рамках диспансеризации на отчетную дату, тыс. рублей', u'Всего', u''], CReportBase.AlignRight),
            ( '15%', [u'', u'в том числе:', u'в рамках I этапа'], CReportBase.AlignRight),
            ( '15%', [u'', u'', u'в рамках II этапа'], CReportBase.AlignRight),
            ( '15%', [u'Количество граждан, направленных на II этап диспансеризации по результатам I этапа диспансеризации, человек', u'', u''], CReportBase.AlignRight),
            ( '15%', [u'Группа состояния здоровья застрахованных лиц, прошедших диспансеризацию', u'I группа здоровья, человек', u''], CReportBase.AlignRight),
            ( '15%', [u'', u'II группа здоровья, человек', u''], CReportBase.AlignRight),
            ( '15%', [u'', u'III группа здоровья, человек', u''], CReportBase.AlignRight),
        ]
