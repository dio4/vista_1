...
# Form implementation generated from reading ui file '.\ReportOrgByDoctorSetup.ui'
#
# Created: Mon Oct 12 14:48:36 2015
...
class Ui_ReportOrgByDoctorSetupDialog(object):
    def setupUi(self, ReportOrgByDoctorSetupDialog):
        ReportOrgByDoctorSetupDialog.setObjectName(_fromUtf8("ReportOrgByDoctorSetupDialog"))
        ...
        self.formLayout.setWidget(5, QtGui.QFormLayout.FieldRole, self.cmbPerson)
        ...
        QtCore.QObject.connect(self.buttonBox, QtCore.SIGNAL(_fromUtf8("rejected()")), ReportOrgByDoctorSetupDialog.reject)
        QtCore.QMetaObject.connectSlotsByName(ReportOrgByDoctorSetupDialog)

    def retranslateUi(self, ReportOrgByDoctorSetupDialog):
        ReportOrgByDoctorSetupDialog.setWindowTitle(_translate("ReportOrgByDoctorSetupDialog", "Dialog", None))
        self.label.setText(_translate("ReportOrgByDoctorSetupDialog", "Дата начала", None))
        self.label_2.setText(_translate("ReportOrgByDoctorSetupDialog", "Дата окончания", None))
        self.label_3.setText(_translate("ReportOrgByDoctorSetupDialog", "Плательщик", None))
        self.label_4.setText(_translate("ReportOrgByDoctorSetupDialog", "Подразделение", None))
        self.label_5.setText(_translate("ReportOrgByDoctorSetupDialog", "Договор", None))
        self.label_6.setText(_translate("ReportOrgByDoctorSetupDialog", "Сотрудник", None))
