...
# Form implementation generated from reading ui file 'ReportActirovaniaSetup.ui'
#
# Created: Fri Feb  6 20:13:19 2015
...
class Ui_ReportActirovaniaSetupDialog(object):
    def setupUi(self, ReportActirovaniaSetupDialog):
        ReportActirovaniaSetupDialog.setObjectName(_fromUtf8("ReportActirovaniaSetupDialog"))
        ReportActirovaniaSetupDialog.resize(468, 149)
        self.layoutWidget = QtGui.QWidget(ReportActirovaniaSetupDialog)
        self.layoutWidget.setGeometry(QtCore.QRect(11, 11, 446, 131))
        ...
        self.retranslateUi(ReportActirovaniaSetupDialog)
        QtCore.QObject.connect(self.buttonBox, QtCore.SIGNAL(_fromUtf8("accepted()")), ReportActirovaniaSetupDialog.accept)
        QtCore.QObject.connect(self.buttonBox, QtCore.SIGNAL(_fromUtf8("rejected()")), ReportActirovaniaSetupDialog.reject)
        QtCore.QMetaObject.connectSlotsByName(ReportActirovaniaSetupDialog)
        ReportActirovaniaSetupDialog.setTabOrder(self.buttonBox, self.edtBegDate)
        ReportActirovaniaSetupDialog.setTabOrder(self.edtBegDate, self.edtEndDate)
        ReportActirovaniaSetupDialog.setTabOrder(self.edtEndDate, self.edtCounterFrom)
        ReportActirovaniaSetupDialog.setTabOrder(self.edtCounterFrom, self.edtCounterTo)

    def retranslateUi(self, ReportActirovaniaSetupDialog):
        ReportActirovaniaSetupDialog.setWindowTitle(_translate("ReportActirovaniaSetupDialog", "Dialog", None))
        self.lblCounter.setText(_translate("ReportActirovaniaSetupDialog", "Выводить по счетчику с", None))
        self.lblEndDate.setText(_translate("ReportActirovaniaSetupDialog", "Дата окончания периода", None))
        self.lblBegDate.setText(_translate("ReportActirovaniaSetupDialog", "Дата начала периода", None))
        self.lblCounterTo.setText(_translate("ReportActirovaniaSetupDialog", "по", None))
