...
# Form implementation generated from reading ui file 'F:\svn-s11\s11\RefBooks\RBDispanserEditor.ui'
#
...
class Ui_ItemEditorDialog(object):
    def setupUi(self, ItemEditorDialog):
        ...
        ItemEditorDialog.resize(301, 109)
        ...
        self.chkObserved = QtGui.QCheckBox(ItemEditorDialog)
        self.chkObserved.setObjectName(_fromUtf8("chkObserved"))
        self.gridlayout.addWidget(self.chkObserved, 2, 1, 1, 1)
        ...
        ItemEditorDialog.setTabOrder(self.chkObserved, self.buttonBox)
    ...
    def retranslateUi(self, ItemEditorDialog):
        ...
        self.chkObserved.setText(QtGui.QApplication.translate("ItemEditorDialog", "Наблюдается", None, QtGui.QApplication.UnicodeUTF8))
