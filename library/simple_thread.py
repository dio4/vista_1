...
class Thread(QThread):
    ...
    def __init__(self, func):
        ...
        # FIXME: atronah: во-первых, сигналы стоит объявлять до использования: атрибут Класса (не объекта) __pyqtSignals__ для данной версии
        # FIXME: atronah: во-вторых, строковые сигналы - устаревший подход, вместо которого рекомендуется использовать QtCore.pyqtSignall()
    ...
    # FIXME: atronah: слот необходимо пердварять декоратором QtCore.pyqtSlot(<types>)
