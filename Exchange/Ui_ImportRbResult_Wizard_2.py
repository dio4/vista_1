...
# Form implementation generated from reading ui file 'F:\svn-s11\s11\Exchange\ImportRbResult_Wizard_2.ui'
#
...
class Ui_ImportRbResult_Wizard_2(object):
    def setupUi(self, ImportRbResult_Wizard_2):
        ...
        self.splitterTree = QtGui.QSplitter(ImportRbResult_Wizard_2)
    ...
    def retranslateUi(self, ImportRbResult_Wizard_2):
        ImportRbResult_Wizard_2.setWindowTitle(QtGui.QApplication.translate("ImportRbResult_Wizard_2", "Список записей", None, QtGui.QApplication.UnicodeUTF8))
        self.btnClearSelection.setText(QtGui.QApplication.translate("ImportRbResult_Wizard_2", "Очистить", None, QtGui.QApplication.UnicodeUTF8))
        self.chkImportAll.setText(QtGui.QApplication.translate("ImportRbResult_Wizard_2", "Загружать всё", None, QtGui.QApplication.UnicodeUTF8))


if __name__ == "__main__":
    import sys
    app = QtGui.QApplication(sys.argv)
    ImportRbResult_Wizard_2 = QtGui.QDialog()
    ui = Ui_ImportRbResult_Wizard_2()
    ui.setupUi(ImportRbResult_Wizard_2)
    ImportRbResult_Wizard_2.show()
    sys.exit(app.exec_())
