...
# Form implementation generated from reading ui file 'ExportRefBooksPage1.ui'
#
# Created: Mon Nov 18 15:55:49 2013
...
class Ui_ExportPage1(object):
    ...
    def retranslateUi(self, ExportPage1):
        ...
        self.lblRefBooks.setText(_translate("ExportPage1", "Настройка справочников", None))
        self.btnExport.setText(_translate("ExportPage1", "экспорт", None))
        self.btnCancel.setText(_translate("ExportPage1", "прервать", None))

from Exchange.Utils import CRefBooksTableView
