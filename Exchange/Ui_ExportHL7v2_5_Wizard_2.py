...
# Form implementation generated from reading ui file 'F:\svn-s11\s11\Exchange\ExportHL7v2_5_Wizard_2.ui'
#
...
class Ui_ExportHL7v2_5_Wizard_2(object):
    ...
    def retranslateUi(self, ExportHL7v2_5_Wizard_2):
        ExportHL7v2_5_Wizard_2.setWindowTitle(QtGui.QApplication.translate("ExportHL7v2_5_Wizard_2", "Экспорт данных о сотрудниках", None, QtGui.QApplication.UnicodeUTF8))
        self.label.setText(QtGui.QApplication.translate("ExportHL7v2_5_Wizard_2", "Экспортировать в", None, QtGui.QApplication.UnicodeUTF8))
        self.btnSelectDir.setText(QtGui.QApplication.translate("ExportHL7v2_5_Wizard_2", "...", None, QtGui.QApplication.UnicodeUTF8))
        self.btnAbort.setText(QtGui.QApplication.translate("ExportHL7v2_5_Wizard_2", "Прервать", None, QtGui.QApplication.UnicodeUTF8))
        self.btnExport.setText(QtGui.QApplication.translate("ExportHL7v2_5_Wizard_2", "Начать экспорт", None, QtGui.QApplication.UnicodeUTF8))
        self.checkRAR.setText(QtGui.QApplication.translate("ExportHL7v2_5_Wizard_2", "Архивировать rar", None, QtGui.QApplication.UnicodeUTF8))
...
if __name__ == "__main__":
    ...
    ExportHL7v2_5_Wizard_2 = QtGui.QDialog()
    ui = Ui_ExportHL7v2_5_Wizard_2()
    ui.setupUi(ExportHL7v2_5_Wizard_2)
    ExportHL7v2_5_Wizard_2.show()
    sys.exit(app.exec_())
