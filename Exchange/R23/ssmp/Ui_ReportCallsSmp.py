...
# Form implementation generated from reading ui file 'ReportCallsSmp.ui'
#
...
class Ui_Dialog(object):
    ...
    def retranslateUi(self, Dialog):
        Dialog.setWindowTitle(_translate("Dialog", "Отчет: вызовы СМП", None))
        self.lblPeriod.setText(_translate("Dialog", "Печать за период:", None))
