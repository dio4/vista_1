...
# Form implementation generated from reading ui file '.\ExportRbThesaurus_Wizard_1.ui'
#
...
class Ui_ExportRbThesaurus_Wizard_1(object):
    def setupUi(self, ExportRbThesaurus_Wizard_1):
        ExportRbThesaurus_Wizard_1.setObjectName(_fromUtf8("ExportRbThesaurus_Wizard_1"))
    ...
    def retranslateUi(self, ExportRbThesaurus_Wizard_1):
        ExportRbThesaurus_Wizard_1.setWindowTitle(_translate("ExportRbThesaurus_Wizard_1", "Список записей", None))
        self.tblItems.setWhatsThis(_translate("ExportRbThesaurus_Wizard_1", "список записей", "ура!"))
        self.btnSelectAll.setText(_translate("ExportRbThesaurus_Wizard_1", "Выбрать все", None))
        self.btnClearSelection.setText(_translate("ExportRbThesaurus_Wizard_1", "Очистить", None))
        self.statusBar.setToolTip(_translate("ExportRbThesaurus_Wizard_1", "A status bar", None))
        self.statusBar.setWhatsThis(_translate("ExportRbThesaurus_Wizard_1", "A status bar.", None))
        self.checkExportAll.setText(_translate("ExportRbThesaurus_Wizard_1", "Выгружать всё", None))
        self.chkRecursiveSelection.setText(_translate("ExportRbThesaurus_Wizard_1", "Выделять все дочерние элементы", None))
