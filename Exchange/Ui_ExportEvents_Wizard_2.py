...
# Form implementation generated from reading ui file 'F:\svn-s11\s11\Exchange\ExportEvents_Wizard_2.ui'
#
...
class Ui_ExportEvents_Wizard_2(object):
    ...
    def retranslateUi(self, ExportEvents_Wizard_2):
        ExportEvents_Wizard_2.setWindowTitle(QtGui.QApplication.translate("ExportEvents_Wizard_2", "Экспорт типов действий", None, QtGui.QApplication.UnicodeUTF8))
        self.label.setText(QtGui.QApplication.translate("ExportEvents_Wizard_2", "Экспортировать в", None, QtGui.QApplication.UnicodeUTF8))
        self.btnSelectFile.setText(QtGui.QApplication.translate("ExportEvents_Wizard_2", "...", None, QtGui.QApplication.UnicodeUTF8))
        self.btnExport.setText(QtGui.QApplication.translate("ExportEvents_Wizard_2", "Начать экспорт", None, QtGui.QApplication.UnicodeUTF8))
        self.checkRAR.setText(QtGui.QApplication.translate("ExportEvents_Wizard_2", "Архивировать rar", None, QtGui.QApplication.UnicodeUTF8))
...
if __name__ == "__main__":
    ...
    ExportEvents_Wizard_2 = QtGui.QDialog()
    ui = Ui_ExportEvents_Wizard_2()
    ui.setupUi(ExportEvents_Wizard_2)
    ExportEvents_Wizard_2.show()
    sys.exit(app.exec_())
