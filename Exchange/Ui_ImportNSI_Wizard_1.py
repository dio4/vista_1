...
# Form implementation generated from reading ui file 'F:\svn-s11\s11\Exchange\ImportNSI_Wizard_1.ui'
#
...
class Ui_ImportNSI_Wizard_1(object):
    ...
    def retranslateUi(self, ImportNSI_Wizard_1):
        ImportNSI_Wizard_1.setWindowTitle(QtGui.QApplication.translate("ImportNSI_Wizard_1", "Импорт справочников НСИ", None, QtGui.QApplication.UnicodeUTF8))
        self.label.setText(QtGui.QApplication.translate("ImportNSI_Wizard_1", "Загрузить из", None, QtGui.QApplication.UnicodeUTF8))
        self.btnSelectDir.setText(QtGui.QApplication.translate("ImportNSI_Wizard_1", "...", None, QtGui.QApplication.UnicodeUTF8))
        self.groupBox.setTitle(QtGui.QApplication.translate("ImportNSI_Wizard_1", "Совпадающие записи", None, QtGui.QApplication.UnicodeUTF8))
        self.rbAskUser.setText(QtGui.QApplication.translate("ImportNSI_Wizard_1", "Спрашивать действие у пользователя", None, QtGui.QApplication.UnicodeUTF8))
        self.rbUpdate.setText(QtGui.QApplication.translate("ImportNSI_Wizard_1", "Обновлять", None, QtGui.QApplication.UnicodeUTF8))
        self.rbSkip.setText(QtGui.QApplication.translate("ImportNSI_Wizard_1", "Пропускать", None, QtGui.QApplication.UnicodeUTF8))
        self.chkFullLog.setText(QtGui.QApplication.translate("ImportNSI_Wizard_1", "Подробный отчет", None, QtGui.QApplication.UnicodeUTF8))


if __name__ == "__main__":
    import sys
    app = QtGui.QApplication(sys.argv)
    ImportNSI_Wizard_1 = QtGui.QDialog()
    ui = Ui_ImportNSI_Wizard_1()
    ui.setupUi(ImportNSI_Wizard_1)
    ImportNSI_Wizard_1.show()
    sys.exit(app.exec_())
