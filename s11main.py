...
# добавил свой триггер на слот. При нажатии кнопки в гл. меню выводится сообщение в окошке
    @QtCore.pyqtSlot()
    def on_actionGo1_triggered(self):
        msg = QMessageBox()
        msg.setWindowTitle(u"новое окно")
        #msg.setInformativeText("This is additional information")
        msg.setDetailedText(u"Дополнительная детализирующая информация")    
        msg.setText(u"Нажатие на новую кноку Go1")
        msg.exec_()
